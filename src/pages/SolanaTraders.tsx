...
const SolanaTraders: React.FC = () => {
  ...
  // Log env variables for debugging and fetch sample data
  useEffect(() => {
    ...
    vectorClient.healthCheck()
      .then(response => {
        ...
        // If health check passes, fetch sample search results
        return vectorClient.getSampleSearchResults();
      })
      .then(results => {
        console.log('Loaded sample search results:', results);
        setSearchResults(results);
        // Set a default search query to match what was searched
        setSearchQuery("economic data and statistics");
      })
      .catch(error => {
    ...
    <div className="min-h-screen bg-lightBg dark:bg-darkBg transition-colors duration-300">
      ...
      <main className="container mx-auto px-4 pb-12">
        ...
        <div className="bg-evenBlock dark:bg-evenBlockDark p-6 rounded-lg shadow-md mt-8 transition-colors duration-300">
          ...
          <p className="text-textDark dark:text-textLight mb-4">
            We're currently displaying sample search results for "<strong>economic data and statistics</strong>". 
